...
const RoundCreatePage = () => {
  ...
  const createMutation = useMutation({
    ...
    onError: (error) => {
      setErrors({ general: error.response?.data?.message || '라운딩 생성에 실패했습니다.' });
    },
  });
            ...
            <MainCard title="안내">
              <Stack spacing={2}>
                <Typography variant="body2" color="text.secondary">
                  라운딩 생성 후 라운딩 상세에서 참가자, 팀, 점수, 비용·정산을 관리할 수 있습니다.
                </Typography>
                <Divider />
                <Typography variant="body2" color="text.secondary">
                  정산은 라운딩별 비용·참가자 기준으로 처리됩니다.
                </Typography>
              </Stack>
            </MainCard>
          </Grid>
