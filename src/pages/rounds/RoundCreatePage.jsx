  ...
  return (
    <Box sx={{ py: 3, px: 0 }}>
      <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
        <Button startIcon={<ArrowLeft />} onClick={() => navigate('/rounds')} sx={{ mr: 2 }}>
          돌아가기
        </Button>
        <Typography variant="h4">라운딩 생성</Typography>
      </Box>
      ...
      <form onSubmit={handleSubmit}>
        <Grid container spacing={3}>
            ...
            <Stack spacing={3}>
              <MainCard title="기본 정보" subheader="라운딩 모임 유형과 소개를 입력하세요.">
                <Stack spacing={3}>
                  ...
                  <FormControlLabel
                    control={<Checkbox checked={formData.is_private} onChange={handlePrivateToggle} />}
              ...
              {formData.is_private && (
                ...
                >
                  <Stack spacing={2}>
                      ...
                      <Paper key={guest.key} variant="outlined" sx={{ p: 2 }}>
                        <Stack spacing={2}>
                          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <IconButton size="small" aria-label="게스트 삭제" onClick={() => removePrivateGuest(index)}>
                              <DeleteIcon />
                            </IconButton>
                          </Box>
                          <TextField
                    ...
                    <Button type="button" variant="outlined" size="small" startIcon={<AddIcon />} onClick={addPrivateGuest}>
                      게스트 추가
                    </Button>
                  </Stack>
                </MainCard>
          ...
          <Grid item xs={12} md={4}>
            <MainCard title="안내">
              <Stack spacing={2}>
                <Typography variant="body2" color="text.secondary">
                  앱의「라운딩 모임 만들기」와 같은 정보로 생성합니다. 생성 후 상세에서 참가자·팀·점수·정산을 관리할 수
                  있습니다.
                </Typography>
                <Divider />
                <Typography variant="body2" color="text.secondary">
                  일반 라운딩: 저장 시 현재 관리자 계정이 참가자로 등록됩니다. 프라이빗: 선택한 클럽 멤버와 추가한
                  게스트만 참가자로 등록됩니다.
                </Typography>
              </Stack>
            </MainCard>
        ...
        <Box sx={{ mt: 3, display: 'flex', justifyContent: 'flex-end', gap: 2 }}>
          ...
          >
            {createMutation.isPending ? '생성 중...' : '라운딩 생성'}
          </Button>
        </Box>
      </form>
    </Box>
