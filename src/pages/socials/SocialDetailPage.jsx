...
import { adminSocialsApi, adminMeetingSettlementApi, adminClientTokenApi, getClientUrl } from '../../lib/api/admin';
        ...
        <Button
          ...
          onClick={async () => {
            try {
              ...
              const url = `${clientUrl}/meetings/social/${id}?admin_token=${tokenData.temp_token}`;
